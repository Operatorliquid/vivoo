...
export function AdminLoginPage({ onLogin }: { onLogin: (session: OwnerSession) => void }) {
  ...
  return (
    <main className="login admin-login">
      ...
      <section className="login__panel page-enter">
        ...
        <h1 className="t-title admin-login__title">Acceso administrativo</h1>
